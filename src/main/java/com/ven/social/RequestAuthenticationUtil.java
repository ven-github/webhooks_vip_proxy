...
public final class RequestAuthenticationUtil {
     ...
     *
     * @param key       auth consumer secret key
     * @param value     message json string
     * @param shaMethod which sha algorithm has to be used to generate digest
     * @return bytearray calculated using above values
     * @throws NoSuchAlgorithmException If sha alogrithm is invalid throws this error
     * @throws InvalidKeyException      if incoming data is not valid
     */
